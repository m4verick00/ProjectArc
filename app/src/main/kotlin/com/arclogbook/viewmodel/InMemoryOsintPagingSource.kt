...
class InMemoryOsintPagingSource(private val provider: () -> List<OsintResult>) : PagingSource<Int, OsintResult>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, OsintResult> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Int, OsintResult>): Int? = 0
}
