...
class InMemoryDeepWebPagingSource(private val provider: () -> List<DeepWebAlert>) : PagingSource<Int, DeepWebAlert>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DeepWebAlert> = try {
    ...
    override fun getRefreshKey(state: PagingState<Int, DeepWebAlert>): Int? = 0
}
